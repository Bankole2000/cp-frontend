      ...
      <v-row>
        <v-col cols="12" class="pa-0">
          ...
          <v-tabs-items v-model="tab" style="background-color: transparent">
            <v-tab-item
              :value="items.indexOf('Following')"
              style="background-color: transparent"
            >
              <ProfileFollowingList :profile="profile" :socket="socket" />
            </v-tab-item>
            <v-tab-item
              :value="items.indexOf('Requests')"
              style="background-color: none"
            >
              <ProfileFollowRequestsList :profile="profile" :socket="socket" />
            </v-tab-item>
          </v-tabs-items>
        </v-col>
      </v-row>
...
import ProfileFollowingList from '~/components/common/profiles/ProfileFollowingList.vue'
import ProfileFollowRequestsList from '~/components/common/profiles/ProfileFollowRequestsList.vue'
export default {
  components: {
